...
def init_args():
    ...
    parser.add_argument("--det_model_dir", type=str, default='C:\server\medical_img_ocr_test2\inference\ch_PP-OCRv3_det_infer')
    ...
    parser.add_argument("--rec_model_dir", type=str, default='C:\server\medical_img_ocr_test2\inference\ch_PP-OCRv3_rec_infer')
    ...
    parser.add_argument(
        "--rec_char_dict_path",
        type=str,
        default=r"ppocr\utils\ppocr_keys_v1.txt")
    ...
    parser.add_argument("--cls_model_dir", type=str, default='C:\server\medical_img_ocr_test2\inference\ch_ppocr_mobile_v2.0_cls_infer')
